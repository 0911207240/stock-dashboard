...
SECTORS = {
    ...
    "低價波段($50以下)": ["友達", "群創", "華邦電", "南亞科", "旺宏", "燁輝", "東和鋼鐵", "大成鋼", "春源鋼鐵", "永豐金", "彰銀", "臺企銀", "開發金", "欣銓", "漢磊", "矽格", "中石化", "亞化", "遠雄", "聯電", "力積電", "穩懋半導體", "台新金", "元大金", "華南金", "中鋼", "台泥", "亞泥", "嘉泥", "環泥", "信大水泥", "國泰永續高股息", "群益台灣精選高息", "復華台灣科技優息", "富邦特選高股息30", "台灣50反1"],
    "槓桿ETF": ["台灣50正2", "台灣50反1"],
